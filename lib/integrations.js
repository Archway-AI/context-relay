...
// `branch` is deliberately ABSENT (Copilot round 9). Every other member is read-only under
// arbitrary trailing arguments, which is the admission criterion this set's `parts[1]` rule
// assumes; `branch` is the one member where trailing arguments flip it to a MUTATION -
