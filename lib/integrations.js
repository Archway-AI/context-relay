...
export async function installClaude(options = {}) {
  ...
  const settingsConfig = parseAgentConfig(existingSettings);
...
export async function installCodex(options = {}) {
  ...
  const hooksConfig = parseAgentConfig(existingHooks);
...
export async function statusAgents(args) {
  ...
  const claudeConfig = parseAgentConfig(claudeSettings);
  const codexConfig = parseAgentConfig(codexHooks);
