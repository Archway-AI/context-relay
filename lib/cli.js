...
// findNpmSubcommandIndex (lib/command-shape.js) are shared with isAllowedCommandShape in
// lib/integrations.js - the PreToolUse rewrite gate has the identical problem, and a second
// divergent implementation of this rule is how the next instance of this bug gets born.
function commandKey(command) {
  ...
  if (["npm", "pnpm", "bun", "yarn"].includes(executable)) {
    const subcommandIndex = findNpmSubcommandIndex(command);
